...
function inviaEmailNotifica(data, totaleZadankai, totalePraticanti) {
    ...
    const templateParams = {
        ...
        zadankai_ospiti_u: data.zadankai_s_u || 0,
        zadankai_ospiti_d: data.zadankai_s_d || 0,
        zadankai_ospiti_gu: data.zadankai_s_gu || 0,
        zadankai_ospiti_gd: data.zadankai_s_gd || 0,
        // Dettagli Praticanti
